...
// Exact same class as JTextField, but this time the letters are blanked out
public class CustomRoundedPasswordField extends JPasswordField implements PositionableAndSizeable, Textable {
    ...
    public CustomRoundedPasswordField(String fontName, int fontStyle, int fontSize,
